...
Of course, the process is more complicated IRL, and not every place works this way. But why are slots called slots? And did "slug" come from the animal, the boxing term (e.g., "He slugged me in the chest"), or better yet, the word for a [bullet fired from a gun](https://en.wikipedia.org/wiki/Slug_(projectile)) (I watch a lot of Law & Order)?

The terms "slot" and "rim" hail from the days when the copy desk was [U-shaped](http://www.theslot.com/slotman.html). The boss would literally sit in the slot of the U, so that he/she could easily hand out assignments to people on the rim.

As for "slug", the answer is none of the above -- the term comes from [hot-metal printing](http://www.nytimes.com/times-insider/2014/11/24/whats-in-a-slug/). A slug was the word for a line of lead, in those days. Linotype machines cast these lead lines, containing text, onto printed pages (also probably where the term "typecasting" comes from!).
...
Today, there's been a flurry of activity about an image that Hillary Clinton's campaign team [tweeted out](http://www.snopes.com/2016/06/07/clinton-secret-win-controversy/) following the Associated Press's report that Clinton had reached the number of delegates needed to win the Democratic presidential nomination. The image associated with the tweet was titled "secret-win-V2-060416c_02.png", leading to rumors of a conspiracy / collusion to prematurely call the race.  
